...
export function AuditConfirmDialog() {
  ...
  const isEn = lang === 'en';
  const isBattle = mode === 'battle' || pendingAudit.isBattlePin;
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          role="dialog"
          aria-modal="true"
          className="relative w-full max-w-md overflow-hidden rounded-2xl border border-accent/30 bg-bg-surface/95 p-6 shadow-glass-xl backdrop-blur-2xl"
        >
          {/* Close button */}
          <button
            type="button"
          ...
          <div className="mb-4 flex items-center gap-3">
            <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-accent/40 bg-accent/15">
          ...
          <div className="mb-5 space-y-3 text-xs leading-relaxed text-text-secondary">
            ...
            {/* Coordinates Card */}
            <div className="flex items-center justify-between rounded-xl border border-white/8 bg-white/[0.03] px-3.5 py-2.5 font-mono text-[11px]">
              <div>
