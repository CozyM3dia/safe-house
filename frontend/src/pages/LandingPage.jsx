...
const COPY = {
  id: {
    ...
    disclaimerText: 'Analisis kami menggunakan data publik dari BNPB InaRISK, BMKG, PVMBG, USGS, dan OpenStreetMap. Laporan screening awal ini TIDAK menggantikan uji tanah laboratorium atau survei geoteknik profesional langsung di lapangan. Konsultasikan dengan ahli struktur berlisensi sebelum mengambil keputusan finansial final.',
    ...
    faqA1: 'S.A.F.E House (Seismic Analysis for Foundation Evaluation) mengubah satu koordinat menjadi parameter SNI 1726:2019 yang dibutuhkan berkas perizinan: kelas situs, PGA desain, FS likuefaksi, dan paparan bahaya.',
  ...
  en: {
    ...
    heroBadge: 'Geotechnical desk study — InaRISK BNPB · USGS · PuSGeN',
    heroTitlePrefix: 'Geological Risk Analysis Made ',
    heroTitleItalic: 'Calculated',
    heroSub: 'SNI 1726:2019 site class, design PGA, liquefaction FS, and flood hazard — from one coordinate, in two minutes. For permitting consultants, developers, and geotechnical engineers.',
    heroCTA: 'Analyze Now',
    ...
    faqA1: 'S.A.F.E House (Seismic Analysis for Foundation Evaluation) turns one coordinate into the SNI 1726:2019 parameters a permitting file needs: site class, design PGA, liquefaction FS, and hazard exposure.',
