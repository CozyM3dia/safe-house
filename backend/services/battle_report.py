...
def _snapshot(audit: AuditResult) -> dict[str, str]:
    ...
    return {
        ...
        "confidence": _number(audit.confidence, digits=0, suffix="%"),
...
def _markdown_table(a: dict[str, str], b: dict[str, str], lang: str) -> str:
    if lang == "en":
        rows = [
            ...
            ("Audit status / confidence", f"{a['audit_status']} / {a['confidence']}", f"{b['audit_status']} / {b['confidence']}"),
        ...
        rows = [
            ...
            ("Status audit / confidence", f"{a['audit_status']} / {a['confidence']}", f"{b['audit_status']} / {b['confidence']}"),
    ...
    *,
    ...
    prompt = {
        ...
        "instructions": [
            ...
            "Jangan menganggap field kosong, sumber gagal, atau confidence rendah sebagai aman.",
